...
void main(){ // main 스레드 갖는 함수
  ...
  bool inStudent = false; // 논리 bool
  String name = "유재석";  // 문자열 String
  print( "이름 ${ name } , 키 : ${ height } , 학생여부 : ${ inStudent } ");

  // [2] 주요 변수/상수 키워드
  var city ="서울";     // JS처럼 자동 타입 추론
  dynamic count = 123;  // *자동타입 + 타입변경가능*
  count = "123명";
  const PI = 3.14159;   // JS 처럼 count 상수(런타임)
  final country = "대한민국"; // JAVA 처럼 final 상수(컴파일)
  ...
  int add( int a , int b ){ return a+b; }
    // int : 반환함수 , add : 함수명, int a / int b : 매개변수
